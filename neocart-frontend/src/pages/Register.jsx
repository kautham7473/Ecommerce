...
function Register() {
  ...
  const checkUsernameAvailability = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_USER_SERVICE_BASE_URL}/auth/check-username?username=${formData.username}`)
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_USER_SERVICE_BASE_URL}/auth/register`, {
        method: "POST",
        headers: {
